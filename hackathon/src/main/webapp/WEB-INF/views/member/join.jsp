...
<body>
   ...
   <div class="supporte_main">
      <div class = "support_form">
        ...
        <div class="support_radio" style="margin-top: 60px;">
          <p class="form_title">회원구분</p>
          <label>
            <input type="radio" name="adminCk" value="2" id="adminCk"/>
            <span>후원자</span>
          </label>
          <label>
            <input type="radio" name="adminCk" value="0" id="adminCk" />
            <span>피후원자</span>
          </label>
        </div>
         ...
         <div class="form_space">
            ...
            <div class="mail_check_wrap">
               ...
               <div class="mail_check_button">
                  <span class = "mail_check_text">인증번호 전송</span>
               </div>
               <style>
                  .mail_check_text {
                     font-size : 22px;
